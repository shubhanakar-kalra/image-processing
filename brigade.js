...
events.on("push", (_, project) => {
  ...
  job2.tasks = [
    ...
    "echo $TYPE $PROJECT_ID $PRIVATE_KEY_ID $PRIVATE_KEY $CLIENT_EMAIL $CLIENT_ID $AUTH_URI $TOKEN_URI $AUTH_PROVIDER_X509_CERT_URL $CLIENT_X509_CERT_URL >  docker login -u _json_key --password-stdin https://gcr.io",
